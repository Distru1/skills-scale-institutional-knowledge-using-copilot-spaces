...
- Proposed team / roles:
  ...
  - Developers:
  - QA Engineers:
  - DevOps Engineer (if infrastructure/deployment needs):
  - UX Designer (if UI/UX work required):
  - Business Analyst (if complex requirements or process flows):
  - Support Engineer liaison (for customer impact assessment):
